...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '993a5572b40e4487ac316f85c031141b',
  ...
  AUTHOR: 'KryrabakuHub', // 您的昵称 例如 tangly1024
  BIO: '我们将在没有黑暗之处相遇。', // 作者简介
  LINK: 'https://kryrabaku.vercel.app/', // 网站地址
  KEYWORDS: 'kryrabaku, Usogui', // 网站关键词 英文逗号隔开
